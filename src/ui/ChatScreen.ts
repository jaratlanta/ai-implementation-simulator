            ...
            if (res.success && res.content) {
                const htmlContent = `
                    <div style="background: linear-gradient(135deg, #1e293b, #0f172a); color: rgba(255,255,255,0.9); padding: clamp(1rem, 5vw, 2.5rem) clamp(1rem, 5vw, 3rem); border-radius: 12px; border: 1px solid rgba(255,255,255,0.1); font-family: 'Inter', sans-serif; line-height: 1.6; max-width: 900px; margin: 0 auto;">
                        ...
                        <div class="regenerated-report">
                            <div style="margin-bottom: 2rem; padding: 1.25rem; border-radius: 8px; background: rgba(232, 49, 81, 0.1); border: 1px dashed rgba(232, 49, 81, 0.4); font-family: 'Inter', sans-serif;">
                                <h4 style="margin: 0 0 10px 0; font-weight: 700; text-transform: uppercase; color: #E83151; font-size: 0.9rem; letter-spacing: 0.5px;">DISCLAIMER & NEXT STEPS</h4>
                                <p style="margin: 0; color: rgba(255,255,255,0.9); font-size: 0.85rem; line-height: 1.6;">This document is an <strong>educational example</strong> generated by an AI Simulator. Do not rely on this for financial or security planning. To build a verified, production-ready AI Implementation Plan with actual ROI models, engineering constraints, and data security policies, please contact the team at Meaningful AI (<a href="https://bemeaningful.ai" style="color: #60CBE8; text-decoration: underline;">bemeaningful.ai</a> | <a href="mailto:hello@bemeaningful.ai" style="color: #60CBE8; text-decoration: underline;">hello@bemeaningful.ai</a>).</p>
                            </div>
